 ...
 * </p>
 *
 * @author Karthick Murugesan Created on 11 Jan 2024
 */
@Configuration
@EnableWebSecurity
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, AuthenticationFilter authenticationFilter)
            throws Exception {
        authenticationFilter.setServiceName(Constants.USER_SERVICE);
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI().info(new Info().title(Constants.USER_SERVICE_OPENAPI_TITLE).version(Constants.OPEN_API_VERSION))
