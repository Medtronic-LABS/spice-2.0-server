...
public interface SmsTemplateRepository extends JpaRepository<SMSTemplate, Long> {
    ...
    public static final String GET_SMS_TEMPLATE = "FROM SMSTemplate as st WHERE st.type in (:list) and "
            + "st.isActive=true and st.isDeleted=false";
     ...
     */
    SMSTemplate findByTypeAndIsActiveTrueAndIsDeletedFalse(String templateType);
