 ...
 * </p>
 *
 * @author vishwa-i2it created on Mar 23, 2023
 */
@Service
public class EmailServiceImpl implements EmailService {
    ...
    public EmailServiceImpl(DiscoveryClient discoveryClient, EmailTemplateRepository emailTemplateRepository, OutBoundEmailRepository outBoundEmailRepository) {
    ...
    public String createNotificationAndSendEmail(EmailDTO email, String sendStatus) {
        try {
            ...
            ResponseEntity<Map<String, Object>> notificationResponse = restService.exchange(
                    emailIp,
                    HttpMethod.POST,
                    notificationEntity,
            ...
            Map<String, Object> status = notificationResponse.getBody();
