...
public interface OutBoundEmailRepository extends JpaRepository<OutBoundEmail, Long> {
    ...
    public static final String GET_OUTBOUND_MAILS = "select mail from OutBoundEmail as mail"
            + " where mail.isProcessed=false and mail.retryAttempts < :emailRetryAttempts and mail.isActive=true and mail.isDeleted=false";
    ...
    public List<OutBoundEmail> getAllMail(@Param("emailRetryAttempts") int emailRetryAttempts);
