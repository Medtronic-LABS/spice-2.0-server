...
public interface PatientNutritionLifestyleService {
     ...
     * @return the updated PatientNutritionLifestyle list entries
     */
    PatientNutritionLifestyleUpdateDTO updatePatientNutritionLifestyle(PatientNutritionLifestyleUpdateDTO patientNutritionLifestyles);
